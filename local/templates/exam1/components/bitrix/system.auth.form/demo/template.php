...
<nav class="menu-block">
	<ul>
					...
					<div class="frm-row">
						...
						<div class="bx-authform-formgroup-container dbg_captha">
							...
							<div class="bx-authform-input-container">
								<input type="text"placeholder="<?=GetMessage("CAPTCHA");?>"  name="captcha_word" maxlength="50" value="" autocomplete="off" />
							</div>
						</div>
					</div>
				<?endif;?>
		...
		<li><a href="<?echo $APPLICATION->GetCurPageParam("register=yes", array(
							"login",
							"logout",
							"forgot_password",
							"change_password"));?>">
