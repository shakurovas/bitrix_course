...
$MESS ["VACANCY_FORM"] = "Рекомендовать кандидата";
$MESS ["VACANCY_FORM2"] = "Откликнуться";
$MESS ["VACANCY_SAVE"] = "Сохранить";
$MESS ["VACANCY_WEBFORM_INSTALL"] = 'Рекомендовать кандидата';
$MESS ["VACANCY_FIELD_REQUIREMENTS"] = 'Требования к кандидату';
$MESS ["VACANCY_FIELD_CONDITIONS"] = 'Условия';
$MESS ["VACANCY_FIELD_INVITE"] = 'Акция ПРИГЛАСИТЬ ДРУГА';
$MESS ["VACANCY_FIELD_INNER"] = 'Акция ВНУТРЕННЯЯ ВАКАНСИЯ';
$MESS ["VACANCY_FIELD_DEPARTMENT"] = 'Отдел';
?>
