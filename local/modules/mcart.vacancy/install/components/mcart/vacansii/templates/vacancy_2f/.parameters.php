...
$arTemplateParameters = array(
	...
	"PREFILTER_PROPERTY_CODE" => array(	
		"PARENT" => "FILTER_SETTINGS",
		"NAME" => GetMessage("T_IBLOCK_DESC_PREFILTER"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"VALUES" => $arProperty_LNS,
		"ADDITIONAL_VALUES" => "Y"
	),
	"PREFILTER_PROPERTY_VALUE" => array(	
		"PARENT" => "FILTER_SETTINGS",
		"NAME" => GetMessage("T_IBLOCK_DESC_PREFILTER_VALUE"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N"
	),

    "VACANCY_FORM_VACANCY_ID" => array(
        "NAME" => GetMessage("VACANCY_FORM_VACANCY_ID"),
        "TYPE" => "STRING",
    ),
    "VACANCY_FORM2_VACANCY_ID" => array(
        "NAME" => GetMessage("VACANCY_FORM2_VACANCY_ID"),
        "TYPE" => "STRING",
    ),
