...
$MESS["T_IBLOCK_DESC_PREFILTER"] = "Предфильтр (эти поля не будут выводиться)";
$MESS["T_IBLOCK_DESC_PREFILTER_VALUE"] = "Предфильтр =";
$MESS ["VACANCY_FORM2_VACANCY_ID"] = "ID web-form ОТКЛИКНУТЬСЯ";
$MESS ["VACANCY_FORM_VACANCY_ID"] = "ID web-form РЕКОМЕНДОВАТЬ КАНДИДАТА";
?>